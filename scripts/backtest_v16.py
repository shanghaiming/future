...
class BacktestV16:
    def __init__(self, initial_capital=500000):
        ...
        self.base_position_pct = 0.30
        self.max_position_pct = 0.40
...
def main():
    data_dir = os.path.expanduser("~/home/futures_platform/data/futures_weighted")
    bt = BacktestV16(initial_capital=500000)
    print("加载期货数据...")
    ...
    with open(os.path.join(output_dir, 'backtest_v16.json'), 'w') as f:
        json.dump({
