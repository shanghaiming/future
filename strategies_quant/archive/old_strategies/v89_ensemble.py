"""
V89 — Ensemble Primary Model (3 LGB configs averaged)
======================================================
Train 3 LGB ranking models with different hyperparameters:
  Config A: num_leaves=7,  feature_fraction=0.4, lr=0.05 (current V88 best)
  Config B: num_leaves=15, feature_fraction=0.6, lr=0.03 (complex)
  Config C: num_leaves=5,  feature_fraction=0.3, lr=0.07 (simple)

Rank-normalize each model's scores per day, then average for consensus.
Same leak-free walk-forward meta as V88.
"""
...
print("=" * 70, flush=True)
print("  V89 — Ensemble Primary Model (3 LGB configs averaged)", flush=True)
print("=" * 70, flush=True)
