"""
V109 — Seed Diversity + Top-K Rotation + Expanded Features
===========================================================
Based on V100 (+413%), revert to close-to-close labels.
Key changes:
  1. 5 seeds × 3 configs = 15 LGB models (vs 9 in v100)
  2. Top-K rotation: hold top 2-3 stocks, rotate daily
  3. Expanded features from v108 (gap, close_pos, volume patterns)
  4. XGB + CB with ranking objective (not binary)
  5. Profit-adaptive hold: winners run longer
Target: 800% annualized
"""
...
print("=" * 70, flush=True)
print("  V109 — Seed Diversity + Top-K Rotation + Expanded Features", flush=True)
print("=" * 70, flush=True)
...
# ====================================================================
N_HAND = 26  # 8 orig deltas + 8 orig ranks + 5 new ranks + 5 new deltas
